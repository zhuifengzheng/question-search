...
public class InviteActivityStatistics {
    private Long inviteActivityStatisticsId;
    ...
    public Long getInviteActivityStatisticsId() {
        return inviteActivityStatisticsId;
    }

    public void setInviteActivityStatisticsId(Long inviteActivityStatisticsId) {
        this.inviteActivityStatisticsId = inviteActivityStatisticsId;
    }
